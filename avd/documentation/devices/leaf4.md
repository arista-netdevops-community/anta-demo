...
| -------------- | ------------------- | --- | -------------- | -------------- | -------------- | ---------- |
| gzip | 192.168.0.5:9910 | default | token,/mnt/flash/cv-onboarding-token | ale,flexCounter,hardware,kni,pulse,strata | /Sysdb/cell/1/agent,/Sysdb/cell/2/agent | False |
...
| Ethernet4 | SERVER_host2_Eth3 | *trunk | *110 | *- | *- | 4 |
| Ethernet5 | SERVER_host2_Eth4 | *trunk | *110 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_spine1_Ethernet5 | - | 172.31.255.13/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_spine2_Ethernet5 | - | 172.31.255.15/31 | default | 1500 | False | - | - |
...
!
interface Ethernet4
   description SERVER_host2_Eth3
   no shutdown
   channel-group 4 mode active
!
interface Ethernet5
   description SERVER_host2_Eth4
   no shutdown
   channel-group 4 mode active
```
...
| Port-Channel4 | PortChanne1 | trunk | 110 | - | - | - | - | 4 | - |
...
router bgp 65102
   ...
   neighbor 192.0.255.2 description spine2_Loopback0
